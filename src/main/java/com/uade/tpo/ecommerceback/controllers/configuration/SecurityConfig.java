...
//                        .requestMatchers("/api/problems/create").permitAll()
//                        .requestMatchers("/api/problems/{problemId}").permitAll()
                        ...
                        .requestMatchers("/api/problems/create").hasRole("VENDEDOR")
                        .requestMatchers("/api/problems/{problemId}").hasRole("VENDEDOR")
